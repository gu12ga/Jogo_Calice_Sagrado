...
public class Tela implements InterfaceUsuario
{
    ...
    private void criarPainelItens() {
        ...
        JScrollPane arearolagem = new JScrollPane(painelItens);
        arearolagem.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
        ...
        janela.add(arearolagem, BorderLayout.EAST);
